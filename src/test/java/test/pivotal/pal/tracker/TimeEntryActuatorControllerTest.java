...
import io.pivotal.pal.tracker.TimeEntryActuatorController;
...
/**
 * Created by e046037 on 11/15/17.
 */
public class TimeEntryActuatorControllerTest {

    private TimeEntryRepository timeEntryRepository;
    private TimeEntryActuatorController controller;
    ...
    public void setUp() throws Exception {
        ...
        controller = new TimeEntryActuatorController(timeEntryRepository, counterService, gaugeService);
    }
